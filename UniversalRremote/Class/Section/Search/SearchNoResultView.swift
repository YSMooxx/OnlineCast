...
class SearchNoResultView:UIView {
    ...
    lazy var tipImage:UIImageView = {
        ...
        let sview:UIImageView = UIImageView(image: UIImage(named: "search_nodata_icon"))
        sview.width = cWH
        sview.height = cWH
        sview.y = 0
    ...
    lazy var tipLabel:UILabel = {
        ...
        sview.text = "1.Please ensure that your local network permissions are enabled.\n2.Please make sure your TV is turned on, and connected to the same wireless network with your TV."
    ...
    lazy var operBtn:UIButton = {
        ...
        sview.setTitle("Refresh", for: .normal)
